...
update-protobufs:
	...
	rm -rf dota/gametoolevents.proto dota/dota_messages_mlbot.proto dota/dota_gcmessages_common_bot_script.proto dota/steammessages_base.proto dota/steammessages_clientserver_login.proto dota/steamdatagram_*.proto dota/steamnetworkingsockets_*.proto dota/*steamworks*.proto dota/tensorflow
